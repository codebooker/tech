! function (e, t) {
    ...
    function c(e, t, n, r) {
        if (it.acceptData(e)) {
            var i, o, a = it.expando,
                ...
                l = s ? it.cache : e,
                u = s ? e[a] : e[a] && a;
            if (u && l[u] && (r || l[u].data) || void 0 !== n || "string" != typeof t) return u || (u = s ? e[a] = G.pop() || it.guid++ : a), l[u] || (l[u] = s ? {} : {
                toJSON: it.noop
    ...
    function k(e) {
        var t = ht,
            n = Zt[e];
        return n || (n = E(e, t), "none" !== n && n || (Kt = (Kt || it("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = (Kt[0].contentWindow || Kt[0].contentDocument).document, t.write(), t.close(), n = E(e, t), Kt.detach()), Zt[e] = n), n
    }
    ...
    function z(e, t, n, r) {
        ...
        if (it.isArray(t)) it.each(t, function (t, i) {
            n || Gn.test(e) ? r(e, i) : z(e + "[" + ("object" == typeof i ? t : "") + "]", i, n, r)
        });
    ...
    var ut = function (e) {
        ...
        function p(e, t, n) {
            ...
            return t.first ? function (t, n, o) {
                ...
                if (a) {
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || i) {
                            if (l = t[B] || (t[B] = {}), (s = l[r]) && s[0] === W && s[1] === o) return u[2] = s[2];
        ...
        var x, w, T, C, E, k, N, S, j, D, A, L, H, q, F, _, M, O, R, B = "sizzle" + -new Date,
            P = e.document,
            W = 0,
            I = 0,
            $ = n(),
        ...
        w = t.support = {}, E = t.isXML = function (e) {
            ...
            var t, n = e ? e.ownerDocument || e : P,
                r = n.defaultView;
            return n !== H && 9 === n.nodeType && n.documentElement ? (H = n, q = n.documentElement, F = !E(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function () {
                L()
                ...
                return q.appendChild(e).id = B, !n.getElementsByName || !n.getElementsByName(B).length
            ...
            }), _ = _.length && new RegExp(_.join("|")), M = M.length && new RegExp(M.join("|")), t = vt.test(q.compareDocumentPosition), R = t || vt.test(q.contains) ? function (e, t) {
                ...
                return r ? r : (r = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & r || !w.sortDetached && t.compareDocumentPosition(e) === r ? e === n || e.ownerDocument === P && R(P, e) ? -1 : t === n || t.ownerDocument === P && R(P, t) ? 1 : D ? tt.call(D, e) - tt.call(D, t) : 0 : 4 & r ? -1 : 1)
            } : function (e, t) {
                if (e === t) return A = !0, 0;
                var r, i = 0,
                    o = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== H && L(e), n = n.replace(dt, "='$1']"), !(!w.matchesSelector || !F || M && M.test(n) || _ && _.test(n))) try {
                var r = O.call(e, n);
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                for (c = g[B] || (g[B] = {}), u = c[e] || [], p = u[0] === W && u[1], f = u[0] === W && u[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (f = p = 0) || h.pop();)
                                    if (1 === d.nodeType && ++f && d === t) {
                                        c[e] = [W, p, f];
                                        break
                                    }
                            } else if (y && (u = (t[B] || (t[B] = {}))[e]) && u[0] === W) f = u[1];
                            else
                                for (;
        ...
        return d.prototype = T.filters = T.pseudos, T.setFilters = new d, k = t.tokenize = function (e, n) {
            ...
            return (u || N(e, d))(r, t, !F, n, bt.test(e) && c(t.parentNode) || t), n
        }, w.sortStable = B.split("").sort(U).join("") === B, w.detectDuplicates = !!A, L(), w.sortDetached = i(function (e) {
    ...
    Jt.optgroup = Jt.option, Jt.tbody = Jt.tfoot = Jt.colgroup = Jt.caption = Jt.thead, Jt.th = Jt.td, it.extend({
        ...
        cleanData: function (e, t) {
            for (var n, r, i, o, a = 0, s = it.expando, l = it.cache, u = nt.deleteExpando, c = it.event.special; null != (n = e[a]); a++)
                if ((t || it.acceptData(n)) && (i = n[s], o = i && l[i])) {
                    ...
                    l[i] && (delete l[i], u ? delete n[s] : typeof n.removeAttribute !== Ct ? n.removeAttribute(s) : n[s] = null, G.push(i))
                }
        }
    }), it.fn.extend({
        text: function (e) {
        ...
        html: function (e) {
            return Dt(this, function (e) {
                ...
                if (!("string" != typeof e || zt.test(e) || !nt.htmlSerialize && Rt.test(e) || !nt.leadingWhitespace && Bt.test(e) || Jt[(Wt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Pt, "<$1></$2>");
                    try {
        ...
        domManip: function (e, t) {
            ...
            if (u && (s = it.buildFragment(e, this[0].ownerDocument, !1, this), n = s.firstChild, 1 === s.childNodes.length && (s = n), n)) {
                ...
                if (i)
                    for (a = o[o.length - 1].ownerDocument, it.map(o, x), l = 0; i > l; l++) r = o[l], Ut.test(r.type || "") && !it._data(r, "globalEval") && it.contains(a, r) && (r.src ? it._evalUrl && it._evalUrl(r.src) : it.globalEval((r.text || r.textContent || r.innerHTML || "").replace(Gt, "")));
                s = n = null
            }
            return this
        }
    ...
    Fn = In.exec(_n.toLowerCase()) || [], it.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function (e, t) {
            ...
            if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, d.url = ((e || d.url || _n) + "").replace(Mn, "").replace(Wn, Fn[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = it.trim(d.dataType || "*").toLowerCase().match(bt) || [""], null == d.crossDomain && (r = In.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === Fn[1] && r[2] === Fn[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (Fn[3] || ("http:" === Fn[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = it.param(d.data, d.traditional)), P($n, d, t, w), 2 === b) return w;
    ...
    it.param = function (e, t) {
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !it(this).is(":disabled") && Qn.test(this.nodeName) && !Yn.test(e) && (this.checked || !At.test(e))
            }).map(function (e, t) {
                var n = it(this).val();
