! function (e, t) {
    ...
    function k(e) {
        var t = ht,
            n = Zt[e];
        return n || (n = E(e, t), "none" !== n && n || (Yt = (Yt || it("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = (Yt[0].contentWindow || Yt[0].contentDocument).document, t.write(), t.close(), n = E(e, t), Yt.detach()), Zt[e] = n), n
    }
    ...
    function j(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++) r = e[a], r.style && (o[a] = it._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && jt(r) && (o[a] = it._data(r, "olddisplay", k(r.nodeName)))) : (i = jt(r), (n && "none" !== n || !i) && it._data(r, "olddisplay", i ? n : it.css(r, "display"))));
    ...
    function M(e, t, n) {
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], u = it.css(e, "display"), c = "none" === u ? it._data(e, "olddisplay") || k(e.nodeName) : u, "inline" === c && "none" === it.css(e, "float") && (nt.inlineBlockNeedsLayout && "inline" !== k(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")), n.overflow && (p.overflow = "hidden", nt.shrinkWrapBlocks() || d.always(function () {
    ...
    function B(e, t, n) {
        var r, i, o = 0,
            ...
            l = function () {
                if (i) return !1;
                for (var t = hn || F(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, a = 0, l = u.tweens.length; l > a; a++) u.tweens[a].run(o);
        ...
        return it.map(c, _, u), it.isFunction(u.opts.start) && u.opts.start.call(e, u), it.fx.timer(it.extend(l, {
            elem: e,
            anim: u,
            queue: u.opts.queue
    ...
    var ut = function (e) {
        function t(e, t, n, r) {
            ...
            if (q && !r) {
                if (i = yt.exec(e))
                    ...
                    if (p = d = R, h = t, m = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
        ...
        var x, w, T, C, E, k, N, S, j, D, A, L, H, F, q, _, M, O, B, R = "sizzle" + -new Date,
            W = e.document,
            P = 0,
            I = 0,
            $ = n(),
        ...
        try {
            Z.apply(J = et.call(W.childNodes), W.childNodes), J[W.childNodes.length].nodeType
        } catch (Ct) {
            Z = {
        ...
        w = t.support = {}, E = t.isXML = function (e) {
            ...
            var t, n = e ? e.ownerDocument || e : W,
                r = n.defaultView;
            return n !== H && 9 === n.nodeType && n.documentElement ? (H = n, F = n.documentElement, q = !E(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function () {
                L()
                ...
                return F.appendChild(e).id = R, !n.getElementsByName || !n.getElementsByName(R).length
            ...
            }, M = [], _ = [], (w.qsa = vt.test(n.querySelectorAll)) && (i(function (e) {
                e.innerHTML = "<select msallowclip=''><option selected=''></option></select>", e.querySelectorAll("[msallowclip^='']").length && _.push("[*^$]=" + rt + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || _.push("\\[" + rt + "*(?:value|" + nt + ")"), e.querySelectorAll(":checked").length || _.push(":checked")
            }), i(function (e) {
            ...
            })), (w.matchesSelector = vt.test(O = F.matches || F.webkitMatchesSelector || F.mozMatchesSelector || F.oMatchesSelector || F.msMatchesSelector)) && i(function (e) {
                w.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), M.push("!=", st)
            }), _ = _.length && new RegExp(_.join("|")), M = M.length && new RegExp(M.join("|")), t = vt.test(F.compareDocumentPosition), B = t || vt.test(F.contains) ? function (e, t) {
                ...
                return r ? r : (r = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & r || !w.sortDetached && t.compareDocumentPosition(e) === r ? e === n || e.ownerDocument === W && B(W, e) ? -1 : t === n || t.ownerDocument === W && B(W, t) ? 1 : D ? tt.call(D, e) - tt.call(D, t) : 0 : 4 & r ? -1 : 1)
            } : function (e, t) {
                if (e === t) return A = !0, 0;
                var r, i = 0,
                    o = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== H && L(e), n = n.replace(dt, "='$1']"), !(!w.matchesSelector || !q || M && M.test(n) || _ && _.test(n))) try {
                var r = O.call(e, n);
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                for (c = g[R] || (g[R] = {}), u = c[e] || [], p = u[0] === P && u[1], f = u[0] === P && u[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (f = p = 0) || h.pop();)
                                    if (1 === d.nodeType && ++f && d === t) {
                                        c[e] = [P, p, f];
                                        break
                                    }
                            } else if (y && (u = (t[R] || (t[R] = {}))[e]) && u[0] === P) f = u[1];
                            else
                                for (;
                                    (d = ++p && d && d[m] || (f = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[R] || (d[R] = {}))[e] = [P, f]), d !== t)););
        ...
        return d.prototype = T.filters = T.pseudos, T.setFilters = new d, k = t.tokenize = function (e, n) {
            ...
            return (u || N(e, d))(r, t, !q, n, bt.test(e) && c(t.parentNode) || t), n
    ...
    it.event = {
        ...
        add: function (e, t, n, r, i) {
            ...
            if (g) {
                for (n.handler && (l = n, n = l.handler, i = l.selector), n.guid || (n.guid = it.guid++), (a = g.events) || (a = g.events = {}), (c = g.handle) || (c = g.handle = function (e) {
                    ...
                    }, c.elem = e), t = (t || "").match(bt) || [""], s = t.length; s--;) o = _t.exec(t[s]) || [], p = m = o[1], h = (o[2] || "").split(".").sort(), p && (u = it.event.special[p] || {}, p = (i ? u.delegateType : u.bindType) || p, u = it.event.special[p] || {}, d = it.extend({
                    type: p,
                    origType: m,
                    data: r,
                    handler: n,
        ...
        fix: function (e) {
            ...
            var t, n, r, i = e.type,
                o = e,
                a = this.fixHooks[i];
            for (a || (this.fixHooks[i] = a = Ft.test(i) ? this.mouseHooks : Ht.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new it.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
    ...
    var Mt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ...
        Jt = m(ht),
        Qt = Jt.appendChild(ht.createElement("div"));
    Gt.optgroup = Gt.option, Gt.tbody = Gt.tfoot = Gt.colgroup = Gt.caption = Gt.thead, Gt.th = Gt.td, it.extend({
        ...
        buildFragment: function (e, t, n, r) {
            for (var i, o, a, s, l, u, c, d = e.length, f = m(t), p = [], h = 0; d > h; h++)
                ...
                if (!nt.leadingWhitespace && Rt.test(o) && p.push(t.createTextNode(Rt.exec(o)[0])), !nt.tbody)
                    for (o = "table" !== l || It.test(o) ? "<table>" !== c[1] || It.test(o) ? 0 : s : s.firstChild, i = o && o.childNodes.length; i--;) it.nodeName(u = o.childNodes[i], "tbody") && !u.childNodes.length && o.removeChild(u);
        ...
        cleanData: function (e, t) {
            for (var n, r, i, o, a = 0, s = it.expando, l = it.cache, u = nt.deleteExpando, c = it.event.special; null != (n = e[a]); a++)
                if ((t || it.acceptData(n)) && (i = n[s], o = i && l[i])) {
                    ...
                    l[i] && (delete l[i], u ? delete n[s] : typeof n.removeAttribute !== Ct ? n.removeAttribute(s) : n[s] = null, V.push(i))
                }
        }
    }), it.fn.extend({
        text: function (e) {
        ...
        html: function (e) {
            return Dt(this, function (e) {
                ...
                if (!("string" != typeof e || zt.test(e) || !nt.htmlSerialize && Bt.test(e) || !nt.leadingWhitespace && Rt.test(e) || Gt[(Pt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Wt, "<$1></$2>");
                    try {
    ...
    it.extend({
        ...
        toggle: function (e) {
            return "boolean" == typeof e ? e ? this.show() : this.hide() : this.each(function () {
                jt(this) ? it(this).show() : it(this).hide()
            })
        }
    ...
    var Tn, Cn, En = it.expr.attrHandle,
    ...
    it.fn.extend({
        ...
        removeAttr: function (e, t) {
            var n, r, i = 0,
                o = t && t.match(bt);
            if (o && 1 === e.nodeType)
                for (; n = o[i++];) r = it.propFix[n] || n, it.expr.match.bool.test(n) ? Sn && Nn || !kn.test(n) ? e[r] = !1 : e[it.camelCase("default-" + n)] = e[r] = !1 : it.attr(e, n, ""), e.removeAttribute(Nn ? n : r)
        },
        attrHooks: {
            type: {
                set: function (e, t) {
        ...
        set: function (e, t, n) {
            return t === !1 ? it.removeAttr(e, n) : Sn && Nn || !kn.test(n) ? e.setAttribute(!Nn && it.propFix[n] || n, n) : e[it.camelCase("default-" + n)] = e[n] = !0, n
        }
    }, it.each(it.expr.match.bool.source.match(/\w+/g), function (e, t) {
        var n = En[t] || it.find.attr;
        En[t] = Sn && Nn || !kn.test(t) ? function (e, t, r) {
            var i, o;
    ...
    it.parseJSON = function (t) {
        ...
        var n, r = null,
            i = it.trim(t + "");
        return i && !it.trim(i.replace(Fn, function (e, t, i, o) {
    ...
    qn = In.exec(_n.toLowerCase()) || [], it.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function (e, t) {
            ...
            if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, d.url = ((e || d.url || _n) + "").replace(Mn, "").replace(Pn, qn[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = it.trim(d.dataType || "*").toLowerCase().match(bt) || [""], null == d.crossDomain && (r = In.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === qn[1] && r[2] === qn[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (qn[3] || ("http:" === qn[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = it.param(d.data, d.traditional)), W($n, d, t, w), 2 === b) return w;
    ...
    it.param = function (e, t) {
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !it(this).is(":disabled") && Qn.test(this.nodeName) && !Jn.test(e) && (this.checked || !At.test(e))
            }).map(function (e, t) {
                var n = it(this).val();
    ...
    it.offset = {
        ...
        offset: function (e) {
            ...
            var t, n, r = {
                ...
                i = this[0],
                o = i && i.ownerDocument;
            if (o) return t = o.documentElement, it.contains(t, i) ? (typeof i.getBoundingClientRect !== Ct && (r = i.getBoundingClientRect()), n = K(o), {
...
function (e, t) {
    ...
    e.rails = n = {
            ...
            if (n.fire(r, "ajax:before")) {
                ...
                return u = {
                    ...
                    beforeSend: function (e, i) {
                        return i.dataType === t && e.setRequestHeader("accept", "*/*;q=0.5, " + i.accepts.script), n.fire(r, "ajax:beforeSend", [e, i]) ? (r.trigger("ajax:send", e), void 0) : !1
                    },
        ...
        handleMethod: function (r) {
            ...
            l === t || s === t || n.isCrossDomain(i) || (c += '<input name="' + l + '" value="' + s + '" type="hidden" />'), a && u.attr("target", a), u.hide().append(c).appendTo("body"), u.submit()
        },
...
function (e, t, n) {
    function r(n, r, i) {
        ...
        return r && (o.id = et + r), i && (o.style.cssText = i), e(o)
    }
    ...
    function c() {
        var t, n = e.data(I, Z);
        null == n ? (O = e.extend({}, Y), console && console.log && console.log("Error: cboxElement missing settings object")) : O = e.extend({}, n);
        for (t in O) e.isFunction(O[t]) && "on" !== t.slice(0, 2) && (O[t] = O[t].call(I));
        O.rel = O.rel || I.rel || e(I).data("rel") || "nofollow", O.href = O.href || e(I).attr("href"), O.title = O.title || I.title, "string" == typeof O.href && (O.href = e.trim(O.href))
    }

    function d(n, r) {
        e(t).trigger(n), lt.trigger(n), e.isFunction(r) && r.call(I)
    }

    function f() {
        var e, t, n, r, i, o = et + "Slideshow_",
            a = "click." + et;
        O.slideshow && k[1] ? (t = function () {
            clearTimeout(e)
        }, n = function () {
            (O.loop || k[$ + 1]) && (e = setTimeout(G.next, O.slideshowSpeed))
        }, r = function () {
            H.html(O.slideshowStop).unbind(a).one(a, i), lt.bind(it, n).bind(rt, t).bind(ot, i), y.removeClass(o + "off").addClass(o + "on")
        }, i = function () {
            t(), lt.unbind(it, n).unbind(rt, t).unbind(ot, i), H.html(O.slideshowStart).unbind(a).one(a, function () {
                G.next(), r()
            }), y.removeClass(o + "on").addClass(o + "off")
        }, O.slideshowAuto ? r() : i()) : y.removeClass(o + "off " + o + "on")
    }

    function p(n) {
        K || (I = n, c(), k = e(I), $ = 0, "nofollow" !== O.rel && (k = e("." + tt).filter(function () {
            var t, n = e.data(this, Z);
            return n && (t = e(this).data("rel") || n.rel || this.rel), t === O.rel
        }), $ = k.index(I), -1 === $ && (k = k.add(I), $ = k.length - 1)), v.css({
            opacity: parseFloat(O.opacity),
            cursor: O.overlayClose ? "pointer" : "auto",
            visibility: "visible"
        }).show(), J && y.add(v).removeClass(J), O.className && y.add(v).addClass(O.className), J = O.className, O.closeButton ? _.html(O.close).appendTo(x) : _.appendTo("<div/>"), X || (X = U = !0, y.css({
            visibility: "hidden",
            display: "block"
        }), S = r(ut, "LoadedContent", "width:0; height:0; overflow:hidden"), x.css({
            width: "",
            height: ""
        }).append(S), B = w.height() + E.height() + x.outerHeight(!0) - x.height(), R = T.width() + C.width() + x.outerWidth(!0) - x.width(), W = S.outerHeight(!0), P = S.outerWidth(!0), O.w = a(O.initialWidth, "x"), O.h = a(O.initialHeight, "y"), G.position(), f(), d(nt, O.onOpen), M.add(A).hide(), y.focus(), O.trapFocus && t.addEventListener && (t.addEventListener("focus", u, !0), lt.one(at, function () {
            t.removeEventListener("focus", u, !0)
        })), O.returnFocus && lt.one(at, function () {
            e(I).focus()
        })), g())
    }

    function h() {
        !y && t.body && (Q = !1, N = e(n), y = r(ut).attr({
            id: Z,
            "class": e.support.opacity === !1 ? et + "IE" : "",
            role: "dialog",
            tabindex: "-1"
        }).hide(), v = r(ut, "Overlay").hide(), D = e([r(ut, "LoadingOverlay")[0], r(ut, "LoadingGraphic")[0]]), b = r(ut, "Wrapper"), x = r(ut, "Content").append(A = r(ut, "Title"), L = r(ut, "Current"), q = e('<button type="button"/>').attr({
            id: et + "Previous"
        }), F = e('<button type="button"/>').attr({
            id: et + "Next"
        }), H = r("button", "Slideshow"), D), _ = e('<button type="button"/>').attr({
            id: et + "Close"
        }), b.append(r(ut).append(r(ut, "TopLeft"), w = r(ut, "TopCenter"), r(ut, "TopRight")), r(ut, !1, "clear:left").append(T = r(ut, "MiddleLeft"), x, C = r(ut, "MiddleRight")), r(ut, !1, "clear:left").append(r(ut, "BottomLeft"), E = r(ut, "BottomCenter"), r(ut, "BottomRight"))).find("div div").css({
            "float": "left"
        }), j = r(ut, !1, "position:absolute; width:9999px; visibility:hidden; display:none"), M = F.add(q).add(L).add(H), e(t.body).append(v, y.append(b, j)))
    }
    ...
    function m() {
        ...
        return y ? (Q || (Q = !0, F.click(function () {
            G.next()
        }), q.click(function () {
            G.prev()
        }), _.click(function () {
            ...
            O.overlayClose && G.close()
        }), e(t).bind("keydown." + et, function (e) {
            var t = e.keyCode;
            X && O.escKey && 27 === t && (e.preventDefault(), G.close()), X && O.arrowKey && k[1] && !e.altKey && (37 === t ? (e.preventDefault(), q.click()) : 39 === t && (e.preventDefault(), F.click()))
        }), e.isFunction(e.fn.on) ? e(t).on("click." + et, "." + tt, n) : e("." + tt).live("click." + et, n)), !0) : !1
    }

    function g() {
        var i, o, u, f = G.prep,
            p = ++ct;
        U = !0, z = !1, I = k[$], c(), d(st), d(rt, O.onLoad), O.h = O.height ? a(O.height, "y") - W - B : O.innerHeight && a(O.innerHeight, "y"), O.w = O.width ? a(O.width, "x") - P - R : O.innerWidth && a(O.innerWidth, "x"), O.mw = O.w, O.mh = O.h, O.maxWidth && (O.mw = a(O.maxWidth, "x") - P - R, O.mw = O.w && O.w < O.mw ? O.w : O.mw), O.maxHeight && (O.mh = a(O.maxHeight, "y") - W - B, O.mh = O.h && O.h < O.mh ? O.h : O.mh), i = O.href, V = setTimeout(function () {
            D.show()
        }, 100), O.inline ? (u = r(ut).hide().insertBefore(e(i)[0]), lt.one(st, function () {
            u.replaceWith(S.children())
        }), f(e(i))) : O.iframe ? f(" ") : O.html ? f(O.html) : s(O, i) ? (i = l(O, i), z = t.createElement("img"), e(z).addClass(et + "Photo").bind("error", function () {
            O.title = !1, f(r(ut, "Error").html(O.imgError))
        }).one("load", function () {
            var t;
            p === ct && (z.alt = e(I).attr("alt") || e(I).attr("data-alt") || "", O.retinaImage && n.devicePixelRatio > 1 && (z.height = z.height / n.devicePixelRatio, z.width = z.width / n.devicePixelRatio), O.scalePhotos && (o = function () {
                z.height -= z.height * t, z.width -= z.width * t
            }, O.mw && z.width > O.mw && (t = (z.width - O.mw) / z.width, o()), O.mh && z.height > O.mh && (t = (z.height - O.mh) / z.height, o())), O.h && (z.style.marginTop = Math.max(O.mh - z.height, 0) / 2 + "px"), k[1] && (O.loop || k[$ + 1]) && (z.style.cursor = "pointer", z.onclick = function () {
                G.next()
            ...
            z.src = i
        }, 1)) : i && j.load(i, O.data, function (t, n) {
            p === ct && f("error" === n ? r(ut, "Error").html(O.xhrError) : e(this).contents())
        })
    }
    var v, y, b, x, w, T, C, E, k, N, S, j, D, A, L, H, F, q, _, M, O, B, R, W, P, I, $, z, X, U, K, V, G, J, Q, Y = {
            transition: "elastic",
            speed: 300,
            fadeOut: 300,
            width: !1,
        ...
        ct = 0,
        dt = {};
    e.colorbox || (e(h), G = e.fn[Z] = e[Z] = function (t, n) {
        var r = this;
        if (t = t || {}, h(), m()) {
            if (e.isFunction(r)) r = e("<a/>"), t.open = !0;
            else if (!r[0]) return r;
            n && (t.onComplete = n), r.each(function () {
                e.data(this, Z, e.extend({}, e.data(this, Z) || Y, t))
            }).addClass(tt), (e.isFunction(t.open) && t.open.call(r) || t.open) && p(r[0])
        }
        return r
    }, G.position = function (t, n) {
        function r() {
            w[0].style.width = E[0].style.width = x[0].style.width = parseInt(y[0].style.width, 10) - R + "px", x[0].style.height = T[0].style.height = C[0].style.height = parseInt(y[0].style.height, 10) - B + "px"
        }
        var o, s, l, u = 0,
            c = 0,
            d = y.offset();
        if (N.unbind("resize." + et), y.css({
                top: -9e4,
                left: -9e4
            }), s = N.scrollTop(), l = N.scrollLeft(), O.fixed ? (d.top -= s, d.left -= l, y.css({
                position: "fixed"
            })) : (u = s, c = l, y.css({
                position: "absolute"
            })), c += O.right !== !1 ? Math.max(N.width() - O.w - P - R - a(O.right, "x"), 0) : O.left !== !1 ? a(O.left, "x") : Math.round(Math.max(N.width() - O.w - P - R, 0) / 2), u += O.bottom !== !1 ? Math.max(i() - O.h - W - B - a(O.bottom, "y"), 0) : O.top !== !1 ? a(O.top, "y") : Math.round(Math.max(i() - O.h - W - B, 0) / 2), y.css({
                top: d.top,
                left: d.left,
                visibility: "visible"
            ...
            var f = 0;
            e.each(o, function (e) {
                return o[e] !== dt[e] ? (f = t, void 0) : void 0
            }), t = f
        }
        dt = o, t || y.css(o), y.dequeue().animate(o, {
            duration: t || 0,
            complete: function () {
                r(), U = !1, b[0].style.width = O.w + P + R + "px", b[0].style.height = O.h + W + B + "px", O.reposition && setTimeout(function () {
                    N.bind("resize." + et, G.position)
                }, 1), n && n()
            },
            step: r
        })
        ...
        var t;
        X && (e = e || {}, e.width && (O.w = a(e.width, "x") - P - R), e.innerWidth && (O.w = a(e.innerWidth, "x")), S.css({
            width: O.w
        }), e.height && (O.h = a(e.height, "y") - W - B), e.innerHeight && (O.h = a(e.innerHeight, "y")), e.innerHeight || e.height || (t = S.scrollTop(), S.css({
            height: "auto"
        }), O.h = S.height()), S.css({
            height: O.h
        }), t && S.scrollTop(t), G.position("none" === O.transition ? 0 : O.speed))
    }, G.prep = function (n) {
        function i() {
            return O.w = O.w || S.width(), O.w = O.mw && O.mw < O.w ? O.mw : O.w, O.w
        }

        function a() {
            return O.h = O.h || S.height(), O.h = O.mh && O.mh < O.h ? O.mh : O.h, O.h
        }
        if (X) {
            var u, c = "none" === O.transition ? 0 : O.speed;
            S.empty().remove(), S = r(ut, "LoadedContent").append(n), S.hide().appendTo(j.show()).css({
                width: i(),
                overflow: O.scrolling ? "auto" : "hidden"
            }).css({
                height: a()
            }).prependTo(x), j.hide(), e(z).css({
                "float": "none"
            }), u = function () {
                function n() {
                ...
                var i, a, u = k.length,
                    ...
                    p = "allowTransparency";
                X && (a = function () {
                    clearTimeout(V), D.hide(), d(it, O.onComplete)
                }, A.html(O.title).add(S).show(), u > 1 ? ("string" == typeof O.current && L.html(O.current.replace("{current}", $ + 1).replace("{total}", u)).show(), F[O.loop || u - 1 > $ ? "show" : "hide"]().html(O.next), q[O.loop || $ ? "show" : "hide"]().html(O.previous), O.slideshow && H.show(), O.preloading && e.each([o(-1), o(1)], function () {
                    var n, r, i = k[this],
                        o = e.data(i, Z);
                    o && o.href ? (n = o.href, e.isFunction(n) && (n = n.call(i))) : n = e(i).attr("href"), n && s(o, n) && (n = l(o, n), r = t.createElement("img"), r.src = n)
                })) : M.hide(), O.iframe ? (i = r("iframe")[0], f in i && (i[f] = 0), p in i && (i[p] = "true"), O.scrolling || (i.scrolling = "no"), e(i).attr({
                    src: O.href,
                ...
                }).one("load", a).appendTo(S), lt.one(st, function () {
                    i.src = "//about:blank"
                }), O.fastIframe && e(i).trigger("load")) : a(), "fade" === O.transition ? y.fadeTo(c, 1, n) : n())
            }, "fade" === O.transition ? y.fadeTo(c, 0, function () {
                G.position(0, u)
            }) : G.position(c, u)
        }
    }, G.next = function () {
        !U && k[1] && (O.loop || k[$ + 1]) && ($ = o(1), p(k[$]))
    }, G.prev = function () {
        !U && k[1] && (O.loop || $) && ($ = o(-1), p(k[$]))
    }, G.close = function () {
        X && !K && (K = !0, X = !1, d(ot, O.onCleanup), N.unbind("." + et), v.fadeTo(O.fadeOut || 0, 0), y.stop().fadeTo(O.fadeOut || 0, 0, function () {
            y.add(v).css({
                opacity: 1,
                cursor: "auto"
            }).hide(), d(st), S.empty().remove(), setTimeout(function () {
                K = !1, d(at, O.onClosed)
            }, 1)
        }))
    }, G.remove = function () {
        y && (y.stop(), e.colorbox.close(), y.stop().remove(), v.remove(), K = !1, y = null, e("." + tt).removeData(Z).removeClass(tt), e(t).unbind("click." + et))
    }, G.element = function () {
        return e(I)
    }, G.settings = Y)
}(jQuery, document, window),
function (e) {
    $colorboxOverlay = "", $colorboxBox = "", e(document).on("ready", function () {
        $colorboxOverlay = e("#cboxOverlay"), $colorboxBox = e("#colorbox"), e(document).on("click", '[data-colorbox="true"]', function (t) {
            t.preventDefault(), e.colorbox({
                height: e(this).data("colorbox-height") || !1,
                width: e(this).data("colorbox-width") || !1,
                maxWidth: e(this).data("colorbox-max-width") || !1,
                maxHeight: e(this).data("colorbox-max-height") || !1,
                iframe: e(this).data("colorbox-iframe") || !1,
                photo: e(this).data("colorbox-photo") || !1,
                innerHeight: e(this).data("colorbox-innerheight") || !1,
                innerWidth: e(this).data("colorbox-innerwidth") || !1,
                title: e(this).data("colorbox-title") || !1,
                className: e(this).data("colorbox-class-name") || !1,
                href: e(this).data("colorbox-href") || e(this).attr("href"),
                html: e(this).data("colorbox-html") || !1,
                inline: e(this).data("colorbox-inline") || !1,
                opacity: .5
            })
        }), e('[data-colorbox-static="true"]').colorbox({
            height: function () {
                return e(this).data("colorbox-height") || !1
            },
            width: function () {
                return e(this).data("colorbox-width") || !1
            },
            maxWidth: function () {
                return e(this).data("colorbox-max-width") || !1
            },
            maxHeight: function () {
                return e(this).data("colorbox-max-height") || !1
            },
            iframe: function () {
                return e(this).data("colorbox-iframe") || !1
            },
            photo: function () {
                return e(this).data("colorbox-photo") || !1
            },
            innerHeight: function () {
                return e(this).data("colorbox-innerheight") || !1
            },
            innerWidth: function () {
                return e(this).data("colorbox-innerwidth") || !1
            },
            title: function () {
                return e(this).data("colorbox-title") || !1
            },
            className: function () {
                return e(this).data("colorbox-class-name") || !1
            },
            href: function () {
                return e(this).data("colorbox-href") || e(this).attr("href")
            },
            html: function () {
                return e(this).data("colorbox-html") || !1
            },
            inline: function () {
                return e(this).data("colorbox-inline") || !1
            },
            opacity: .5
        })
    }), e(document).on("page:change", function () {
        $colorboxOverlay && $colorboxOverlay.appendTo("body"), $colorboxBox && $colorboxBox.appendTo("body")
    })
}(jQuery);